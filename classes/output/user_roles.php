...
namespace local_course_studentreports\output;
...
/**
 * Slight modified version of core class to display list of user roles.
 *
 ...
 */
class user_roles extends \core\output\inplace_editable {
    ...
    public function __construct($course, $context, $user, $courseroles, $assignableroles, $profileroles, $userroles, $viewableroles = null) {
        ...
        parent::__construct('core_user', 'user_roles', $itemid, false, $value, $value);
